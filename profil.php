<?php
    ...
    if(isset($_POST['ubahakun'])){
        ...
        $ubahacc = ubahaccount($_POST);
        if( $ubahacc > 0 ) {
            echo "<script>
            alert('Akun Anda berhasil diubah!')
            </script>";
        }
        else
        {
            echo "<script>
            alert('Akun Anda gagal diubah!')
            </script>";
        }
    }
                ...
                <div class="col-6 id">
                    <form>
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="varchar" value="<?= $username ?>" disabled readonly>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input class="form-control" type="varchar" value="<?= $psw ?>" disabled readonly>
                        </div>
                        <a href="editakun.php?id_akun=<?= $id_akun ?>" tabindex="-1" aria-disabled="true" class="btn btn-outline-warning mr-1" type="submit">Change</a>
                    </form>
                </div>
            </div>
            <div class="row form">
                ...
                <div class="col-6 kanan">
                        ...
                        <a href="editprofile.php?id=<?= $row["id"]; ?>" tabindex="-1" aria-disabled="true" class="btn btn-outline-warning mr-1" type="submit">Edit Profile</a>
                </div>
            </div>
            <?php endwhile; ?>
        </div>
